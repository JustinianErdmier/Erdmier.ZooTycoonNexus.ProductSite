...
/// <param name="Kind">
///     The display kind, which determines the CSS colour token applied to the value span. Use <see cref="IniEntryKinds.Ok" /> for confirmed values,
///     <see cref="IniEntryKinds.Value" /> for regular config values, and <see cref="IniEntryKinds.Key" /> for key-path-style values.
/// </param>
